...
#  Created on Sat May  1 23:43:06 2021                
#                                                     
#######################################################
...
getIoFlowFlag
setIoFlowFlag 0
floorPlan -coreMarginsBy die -site tsm3site -r 1 0.699997 4.0 4.0 4.0 4.0
uiSetTool select
getIoFlowFlag
fit
...
group_path -name in2reg_tmp.20908 -from {0xf 0x12} -to 0x13 -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.20908 -from {0x16 0x19} -to 0x1a -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.20908 -from 0x1c -to 0x1d
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.20908 -from 0x20 -to 0x21
setPathGroupOptions reg2reg_tmp.20908 -effortLevel high
reset_path_group -name reg2out_tmp.20908
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2reg_tmp.20908
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2out_tmp.20908
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name reg2reg_tmp.20908
set_global _is_ipo_interactive_path_groups 0
