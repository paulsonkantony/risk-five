...
#  Created on Wed Mar 31 13:11:05 2021                
#                                                     
#######################################################
...
set init_verilog netlist_core.v
...
getIoFlowFlag
setIoFlowFlag 0
floorPlan -coreMarginsBy die -site tsm3site -r 1 0.699996 4.0 4.0 4.0 4.0
uiSetTool select
getIoFlowFlag
fit
setIoFlowFlag 0
floorPlan -site tsm3site -r 0.987636363636 0.69989 4.62 4.48 4.62 4.48
uiSetTool select
getIoFlowFlag
fit
...
group_path -name in2reg_tmp.19094 -from {0xf 0x12} -to 0x13 -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.19094 -from {0x16 0x19} -to 0x1a -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.19094 -from 0x1c -to 0x1d
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.19094 -from 0x20 -to 0x21
setPathGroupOptions reg2reg_tmp.19094 -effortLevel high
reset_path_group -name reg2out_tmp.19094
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2out_tmp.19094
set_global _is_ipo_interactive_path_groups 0
...
getPlaceMode -quiet -tdgpAdjustNetWeightBySlack
getPlaceMode -exp_slack_driven -quiet
reset_path_group -name reg2reg_tmp.19094
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2reg_tmp.19094
set_global _is_ipo_interactive_path_groups 0
...
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2reg_tmp.19094 -from {0x25 0x28} -to 0x29 -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.19094 -from {0x2c 0x2f} -to 0x30 -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.19094 -from 0x32 -to 0x33
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.19094 -from 0x36 -to 0x37
setPathGroupOptions reg2reg_tmp.19094 -effortLevel high
reset_path_group -name reg2out_tmp.19094
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2out_tmp.19094
...
saveDesign core
saveDesign core
gui_select -rect {-82.820 351.978 -65.644 146.872}
zoomIn
zoomIn
zoomIn
zoomIn
zoomIn
zoomOut
gui_select -rect {249.568 251.627 252.750 251.465}
fit
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -preCTS -pathReports -slackReports -numPaths 50 -prefix core_preCTS -outDir timingReports
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -preCTS -pathReports -slackReports -numPaths 50 -prefix core_preCTS -outDir timingReports
...
reset_parasitics
extractRC
rcOut -setload core.setload
rcOut -setres core.setres
rcOut -spf core.spf
rcOut -spef core.spef
reset_parasitics
extractRC
rcOut -setload core.setload
rcOut -setres core.setres
...
write_sdf  -ideal_clock_network core.sdf
write_sdf  -ideal_clock_network core.sdf
...
report_power -rail_analysis_format VS -outfile ./core.rpt
set_power_output_dir -reset
set_power_output_dir .
set_default_switching_activity -reset
set_default_switching_activity -input_activity 0.2 -period 10.0
...
set dbgLefDefOutVersion 5.8
defOut -floorplan -netlist -routing core.def
set dbgLefDefOutVersion 5.8
set dbgLefDefOutVersion 5.8
set dbgLefDefOutVersion 5.8
global dbgLefDefOutVersion
...
set dbgLefDefOutVersion 5.8
set dbgLefDefOutVersion 5.8
reportGateCount -level 5 -limit 100 -outfile core.gateCount
