...
#  Created on Sat May  1 21:16:39 2021                
#                                                     
#######################################################
...
group_path -name in2reg_tmp.12813 -from {0xf 0x12} -to 0x13 -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.12813 -from {0x16 0x19} -to 0x1a -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.12813 -from 0x1c -to 0x1d
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.12813 -from 0x20 -to 0x21
setPathGroupOptions reg2reg_tmp.12813 -effortLevel high
reset_path_group -name reg2out_tmp.12813
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2reg_tmp.12813
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2out_tmp.12813
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name reg2reg_tmp.12813
set_global _is_ipo_interactive_path_groups 0
