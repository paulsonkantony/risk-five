...
#  Created on Mon Apr 12 18:50:43 2021                
#                                                     
#######################################################
...
group_path -name in2reg_tmp.29687 -from {0x8 0xb} -to 0xc -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.29687 -from {0xf 0x12} -to 0x13 -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.29687 -from 0x15 -to 0x16
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.29687 -from 0x19 -to 0x1a
setPathGroupOptions reg2reg_tmp.29687 -effortLevel high
reset_path_group -name reg2out_tmp.29687
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2reg_tmp.29687
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2out_tmp.29687
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name reg2reg_tmp.29687
set_global _is_ipo_interactive_path_groups 0
