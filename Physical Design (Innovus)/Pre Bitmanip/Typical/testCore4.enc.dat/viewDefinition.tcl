...
create_constraint_mode -name constraint_top\
   -sdc_files\
    [list ${::IMEX::dataVar}/mmmc/modes/constraint_top/constraint_top.sdc]
create_analysis_view -name worst -constraint_mode constraint_top -delay_corner max -latency_file ${::IMEX::dataVar}/mmmc/views/worst/latency.sdc
create_analysis_view -name best -constraint_mode constraint_top -delay_corner min -latency_file ${::IMEX::dataVar}/mmmc/views/best/latency.sdc
